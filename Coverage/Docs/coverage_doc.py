...
## @brief Checks if a point is contained within a bounding box's y axis
#
#
...
## @brief Checks if a point is contained within the bounding box's x axis
#
#
# @param		bounds	The bounding box
...
#
#
# @param		points	The points from Quantise, will be used as nodes in the
# @param		            graph
#
# @return
...
## @brief Creates a rectangular box which wholey contains the given shape
#
#
# @param		shape	The shape to produce a bounding box for
#
...
## @brief Quantises a shape within a bounding box
#
#    Each point will be the centroid of a box the size of the robot.
#
#
# @param		shape	The perimeter of the shape to quantise
# @param		height	The height of the robot
# @param		width	The width of the robot
# @param		overlap	The desired overlap of the route
#
# @return
...
## @brief Converts the perimeters and nogo zones from GPS to UTM
#
...
#
#
# @param		xy_per	The perimeter in UTM
# @param		xy_nogos	A list of nogo zones in UTM
# @param		width	The width of the robot
#
# @return
...
def main():
    ...
    nogos = list((np.array([[52.483155075712666, 1.7109081770028178],
